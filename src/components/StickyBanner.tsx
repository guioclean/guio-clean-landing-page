...
const StickyBanner = () => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-[60] bg-accent text-accent-foreground" role="region" aria-label="Cupom promocional">
      <div className="container mx-auto px-4 py-2.5 flex items-center justify-center gap-3 text-sm font-heading font-bold">
        ...
        <button
          onClick={handleCopy}
          aria-label={`Copiar cupom ${code} (5% de desconto)`}
        ...
        {copied && (
          <span role="status" className="absolute right-4 top-1/2 -translate-y-1/2 bg-green-600 text-white text-xs px-3 py-1 rounded-full animate-in fade-in slide-in-from-right-4">
